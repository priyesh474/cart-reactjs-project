...
import { toggleCart, toggleDarkMode } from '../features/cartSlice';
    ...
    <header className="header">
      ...
      <div className="right">
        <ul className="nav-list">
          ...
          <li><NavLink to="/products" className={({ isActive }) => (isActive ? 'active' : '')}>
              Product List
              </NavLink>
            </li>
          <li className='toggle-btn'>
            <img src={d1} alt="Toggle Dark Mode" onClick={handleDarkModeToggle} />
          </li>
        </ul>
